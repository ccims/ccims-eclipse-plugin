 ...
 * </p>
 * <ul>
 *   <li>{@link de.unistuttgart.iste.rss.ccims.eclipseplugin.datamodel.impl.LocationImpl#getResourcePath <em>Resource Path</em>}</li>
 *   <li>{@link de.unistuttgart.iste.rss.ccims.eclipseplugin.datamodel.impl.LocationImpl#getLine <em>Line</em>}</li>
 *   <li>{@link de.unistuttgart.iste.rss.ccims.eclipseplugin.datamodel.impl.LocationImpl#getComponent <em>Component</em>}</li>
 *   <li>{@link de.unistuttgart.iste.rss.ccims.eclipseplugin.datamodel.impl.LocationImpl#getInterface <em>Interface</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocationImpl extends MinimalEObjectImpl.Container implements Location {
    ...
    protected EClass eStaticClass() {
        return CcimsDatamodelPackage.Literals.LOCATION;
    }
    ...
    public void setLine(int newLine) {
        ...
        line = newLine;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CcimsDatamodelPackage.LOCATION__LINE, oldLine, line));
    }
    ...
    public Component getComponent() {
        if (component != null && component.eIsProxy()) {
            ...
            if (component != oldComponent) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, CcimsDatamodelPackage.LOCATION__COMPONENT, oldComponent, component));
            }
        }
        return component;
    }
    ...
    public void setComponent(Component newComponent) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CcimsDatamodelPackage.LOCATION__COMPONENT, oldComponent, component));
    }
    ...
    public Interface getInterface() {
        if (interface_ != null && interface_.eIsProxy()) {
            ...
            if (interface_ != oldInterface) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, CcimsDatamodelPackage.LOCATION__INTERFACE, oldInterface, interface_));
            }
        }
        return interface_;
    }
    ...
    public void setInterface(Interface newInterface) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CcimsDatamodelPackage.LOCATION__INTERFACE, oldInterface, interface_));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case CcimsDatamodelPackage.LOCATION__LINE:
                return getLine();
            case CcimsDatamodelPackage.LOCATION__COMPONENT:
                if (resolve) return getComponent();
                return basicGetComponent();
            case CcimsDatamodelPackage.LOCATION__INTERFACE:
