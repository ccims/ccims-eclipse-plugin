...
public class RemoveLabelPayload extends AbstractResponse<RemoveLabelPayload> {
    public RemoveLabelPayload() {
    }

    public RemoveLabelPayload(JsonObject fields) throws SchemaViolationError {
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                ...
                case "event": {
                    UnlabelledEvent optional1 = null;
                    if (!field.getValue().isJsonNull()) {
                        optional1 = new UnlabelledEvent(jsonAsObject(field.getValue(), key));
                    }
    ...
    public RemoveLabelPayload setClientMutationId(String arg) {
    ...
    public RemoveLabelPayload setLabel(Label arg) {
    ...
    public RemoveLabelPayload setIssue(Issue arg) {
        optimisticData.put(getKey("issue"), arg);
        return this;
    }

    public UnlabelledEvent getEvent() {
        return (UnlabelledEvent) get("event");
    }

    public RemoveLabelPayload setEvent(UnlabelledEvent arg) {
    ...
    public RemoveLabelPayload setTimelineEdge(IssueTimelineItemEdge arg) {
