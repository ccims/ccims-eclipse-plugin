...
public class UnpinIssueInput implements Serializable {
    private ID issue;
    ...
    public UnpinIssueInput(ID issue, ID component) {
        this.issue = issue;
    ...
    public UnpinIssueInput setIssue(ID issue) {
        this.issue = issue;
        return this;
    }
    ...
    public UnpinIssueInput setComponent(ID component) {
        this.component = component;
        return this;
    }
    ...
    public UnpinIssueInput setClientMutationId(String clientMutationId) {
        this.clientMutationId = Input.optional(clientMutationId);
        return this;
    }

    public UnpinIssueInput setClientMutationIdInput(Input<String> clientMutationId) {
