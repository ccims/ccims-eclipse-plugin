...
public class RemoveIssueFromLocationPayloadQuery extends Query<RemoveIssueFromLocationPayloadQuery> {
    ...
    public RemoveIssueFromLocationPayloadQuery removedLocation(IssueLocationQueryDefinition queryDef) {
    ...
    public RemoveIssueFromLocationPayloadQuery event(AddedLocationEventQueryDefinition queryDef) {
        startField("event");
