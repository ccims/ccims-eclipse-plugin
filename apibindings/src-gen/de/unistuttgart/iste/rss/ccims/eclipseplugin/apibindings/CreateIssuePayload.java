...
public class CreateIssuePayload extends AbstractResponse<CreateIssuePayload> {
    public CreateIssuePayload() {
    }

    public CreateIssuePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public CreateIssuePayload setClientMutationId(String arg) {
    ...
    public CreateIssuePayload setIssue(Issue arg) {
