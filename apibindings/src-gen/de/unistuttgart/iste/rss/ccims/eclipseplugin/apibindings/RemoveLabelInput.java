...
public class RemoveLabelInput implements Serializable {
    private ID issue;
    ...
    public RemoveLabelInput(ID issue, ID label) {
        this.issue = issue;
    ...
    public RemoveLabelInput setIssue(ID issue) {
        this.issue = issue;
        return this;
    }
    ...
    public RemoveLabelInput setLabel(ID label) {
        this.label = label;
        return this;
    }
    ...
    public RemoveLabelInput setClientMutationId(String clientMutationId) {
        this.clientMutationId = Input.optional(clientMutationId);
        return this;
    }

    public RemoveLabelInput setClientMutationIdInput(Input<String> clientMutationId) {
