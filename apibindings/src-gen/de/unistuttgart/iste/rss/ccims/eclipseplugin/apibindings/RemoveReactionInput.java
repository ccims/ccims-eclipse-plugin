...
public class RemoveReactionInput implements Serializable {
    private String reactionToRemove;

    private Input<String> clientMutationId = Input.undefined();

    public RemoveReactionInput(String reactionToRemove) {
    ...
    public RemoveReactionInput setReactionToRemove(String reactionToRemove) {
        this.reactionToRemove = reactionToRemove;
        return this;
    }
    ...
    public RemoveReactionInput setClientMutationId(String clientMutationId) {
        this.clientMutationId = Input.optional(clientMutationId);
        return this;
    }

    public RemoveReactionInput setClientMutationIdInput(Input<String> clientMutationId) {
