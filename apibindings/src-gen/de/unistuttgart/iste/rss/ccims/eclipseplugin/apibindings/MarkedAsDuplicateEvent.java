...
public class MarkedAsDuplicateEvent extends AbstractResponse<MarkedAsDuplicateEvent> implements IssueTimelineItem, Node {
    public MarkedAsDuplicateEvent() {
    }

    public MarkedAsDuplicateEvent(JsonObject fields) throws SchemaViolationError {
    ...
    public MarkedAsDuplicateEvent(ID id) {
        this();
    ...
    public MarkedAsDuplicateEvent setIssue(Issue arg) {
    ...
    public MarkedAsDuplicateEvent setCreatedBy(User arg) {
    ...
    public MarkedAsDuplicateEvent setCreatedAt(String arg) {
    ...
    public MarkedAsDuplicateEvent setOriginalIssue(Issue arg) {
