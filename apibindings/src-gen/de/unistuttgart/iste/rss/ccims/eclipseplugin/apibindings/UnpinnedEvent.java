...
public class UnpinnedEvent extends AbstractResponse<UnpinnedEvent> implements IssueTimelineItem, Node {
    public UnpinnedEvent() {
    }

    public UnpinnedEvent(JsonObject fields) throws SchemaViolationError {
    ...
    public UnpinnedEvent setIssue(Issue arg) {
    ...
    public UnpinnedEvent setCreatedBy(User arg) {
    ...
    public UnpinnedEvent setCreatedAt(String arg) {
