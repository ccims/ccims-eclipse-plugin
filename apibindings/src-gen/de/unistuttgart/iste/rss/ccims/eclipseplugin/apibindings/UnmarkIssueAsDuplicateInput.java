...
public class UnmarkIssueAsDuplicateInput implements Serializable {
    private ID issue;

    private Input<String> clientMutationId = Input.undefined();

    public UnmarkIssueAsDuplicateInput(ID issue) {
        this.issue = issue;
    }
    ...
    public UnmarkIssueAsDuplicateInput setIssue(ID issue) {
        this.issue = issue;
        return this;
    }
    ...
    public UnmarkIssueAsDuplicateInput setClientMutationId(String clientMutationId) {
        this.clientMutationId = Input.optional(clientMutationId);
        return this;
    }

    public UnmarkIssueAsDuplicateInput setClientMutationIdInput(Input<String> clientMutationId) {
