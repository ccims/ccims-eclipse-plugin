...
public class AssignedEvent extends AbstractResponse<AssignedEvent> implements IssueTimelineItem, Node {
    public AssignedEvent() {
    }

    public AssignedEvent(JsonObject fields) throws SchemaViolationError {
    ...
    public AssignedEvent setIssue(Issue arg) {
    ...
    public AssignedEvent setCreatedBy(User arg) {
    ...
    public AssignedEvent setCreatedAt(String arg) {
    ...
    public AssignedEvent setAssignee(User arg) {
